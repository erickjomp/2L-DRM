MODULE global_data
    ...
    integer, save :: ndays!= 123+15 !196 ! 120+15 months-01to04 no leapyear ! 123+15  months-05to08  ! 122+15  months-09to12   ! CHANGE 
    ...
    integer, save :: day1, day2!= 123+15 !196  !123+15  !day1=16, day2=   !date starts and ends simulation
    ...
    integer, save :: velocity_dt! = 3  !time interval of velocity data (in hours)     ! CHANGE 
    ...
    !!!!! derived variables 
    integer, save :: n_days_tracing
    integer, save :: n_dt_tracing
    ...
    ! real(4), dimension(bigx,bigy,ndays),save          :: PP, ET
    ! real(4), dimension(bigx,bigy,nslabs,ndays), save  :: PW
    ! real(4), dimension(bigx,bigy,nslabs, &
    !                     ndays*24/velocity_dt),save    :: U3, V3
    ! integer, dimension(domsize,2), save               :: domain_ij  ! should be dimension(2, domsize) to be more efficient

    ! ! these will be calculated
    ! real(4), dimension(bigx,bigy,nslabs-1,ndays),save :: PW_FLUX
    ! integer, dimension(bigx,bigy,nslabs-1,ndays),save :: MASK_PW_FLUX 
    ! tracing_dt
